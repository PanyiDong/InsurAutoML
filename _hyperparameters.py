...
classifier_hyperparameter = [
    {
        ...
        'n_estimators' : scope.int(hp.quniform('AdaboostClassifier_n_estimators', 10, 500, 1)), 
    ...
    },
    {
        ...
        'max_depth_factor' : hp.uniform('DecisionTree_max_depth_factor', 0., 2.),
        'min_samples_split' : scope.int(hp.quniform('DecisionTree_min_samples_split', 2, 20, 1)), 
        'min_samples_leaf' : scope.int(hp.quniform('DecisionTree_min_samples_leaf', 1, 20, 1)), 
        'min_weight_fraction_leaf' : hp.choice('DecisionTree_min_weight_fraction_leaf', [0.0]),
    ...
    },
    {
        ...
        'min_samples_leaf' : scope.int(hp.quniform('ExtraTreesClassifier_min_samples_leaf', 1, 20, 1)),
        'min_samples_split' : scope.int(hp.quniform('ExtraTreesClassifier_min_samples_split', 2, 20, 1)),  
        'max_features' : hp.uniform('ExtraTreesClassifier_max_features', 0., 1.), 
        ...
        'min_weight_fraction_leaf' : hp.choice('ExtraTreesClassifier_min_weight_fraction_leaf', [0.]), 
        'min_impurity_decrease' : hp.choice('ExtraTreesClassifier_min_impurity_decrease', [0.0])
    },
    {
        'model' : 'GaussianNB'
    },
    {
        ...
        'learning_rate' : hp.loguniform('GradientBoostingClassifier_learning_rate', np.log(0.01), np.log(1)), 
        'min_samples_leaf' : scope.int(hp.loguniform('GradientBoostingClassifier_min_samples_leaf', \
            np.log(1), np.log(200))), 
        'max_depth' : hp.choice('GradientBoostingClassifier_max_depth', ['None']),
        'max_leaf_nodes' : scope.int(hp.loguniform('GradientBoostingClassifier_max_leaf_nodes', \
            np.log(3), np.log(2047))), 
        'max_bins' : hp.choice('GradientBoostingClassifier_max_bins', [255]), 
        'l2_regularization' : hp.loguniform('GradientBoostingClassifier_l2_regularization', \
        ...
        'validation_fraction' : hp.uniform('GradientBoostingClassifier_validation_fraction', 0.01, 0.4)
    },
    {
        'model' : 'KNearestNeighborsClassifier',
        'n_neighbors' : scope.int(hp.quniform('KNearestNeighborsClassifier_n_neighbors', 1, 100, 1)), 
    ...
    },
    {
        ...
        'shrinkage_factor' : hp.uniform('LDA', 0., 1.),
    ...
    {
        'model' : 'MLPClassifier',
        'hidden_layer_depth' : scope.int(hp.quniform('MLPClassifier_hidden_layer_depth', 1, 3, 1)), 
        'num_nodes_per_layer' : scope.int(hp.loguniform('MLPClassifier_num_nodes_per_layer', \
            np.log(16), np.log(264))), 
        'activation' : hp.choice('MLPClassifier_activation', ['tanh', 'relu']), 
        'alpha' : hp.loguniform('MLPClassifier_alpha', np.log(1e-7), np.log(1e-1)),
        'learning_rate_init' : hp.loguniform('MLPClassifier_learning_rate_init', np.log(1e-4), np.log(0.5)), 
    ...
    {
        'model' : 'QDA',
        'reg_param' : hp.uniform('QDA_reg_param', 0.0, 1.0)
    },
    {
        'model' : 'RandomForest',
        'criterion' : hp.choice('RandomForest_criterion', ['gini', 'entropy']), 
        'max_features' : hp.uniform('RandomForest_max_features', 0., 1.),
        'max_depth' : hp.choice('RandomForest_max_depth', [None]), 
        'min_samples_split' : scope.int(hp.quniform('RandomForest_min_samples_split', 2, 20, 1)), 
        'min_samples_leaf' : scope.int(hp.quniform('RandomForest_min_samples_leaf', 1, 20, 1)),
        'min_weight_fraction_leaf' : hp.choice('RandomForest_min_weight_fraction_leaf', [0.]), 
    ...
    },
    {
        ...
        'learning_rate' : hp.choice('SGD_learning_rate', ['constant', 'optimal', 'invscaling']),
...
regressor_hyperparameters = [
    {
        ...
        'n_estimators' : scope.int(hp.quniform('AdaboostRegressor_n_estimators', 50, 500, 1)), 
        'learning_rate' : hp.loguniform('AdaboostRegressor_learning_rate', np.log(0.01), np.log(2)), 
        'loss' : hp.choice('AdaboostRegressor_algorithm', ['linear', 'square', 'exponential']), 
        # for base_estimator of Decision Tree
    ...
    },
    {
        ...
        'lambda_1' : hp.loguniform('ARDRegression_lambda_1', np.log(1e-10), np.log(1e-3)), 
        'lambda_2' : hp.loguniform('ARDRegression_lambda_2', np.log(1e-10), np.log(1e-3)),
        'threshold_lambda' : hp.loguniform('ARDRegression_threshold_lambda', np.log(1e3), np.log(1e5)), 
        'fit_intercept' : hp.choice('ARDRegression_fit_intercept', [True])
    },
    {
        'model' : 'DecisionTree',
        'criterion' : hp.choice('DecisionTree_criterion', ['mse', 'friedman_mse', 'mae']), 
        'max_features' : hp.choice('DecisionTree_max_features', [1.0]), 
        'max_depth_factor' : hp.uniform('DecisionTree_max_depth_factor', 0., 2.),
        'min_samples_split' : scope.int(hp.quniform('DecisionTree_min_samples_split', 2, 20, 1)), 
        'min_samples_leaf' : scope.int(hp.quniform('DecisionTree_min_samples_leaf', 1, 20, 1)), 
    ...
    },
    {
        ...
        'criterion' : hp.choice('ExtraTreesRegressor_criterion', ['mse', 'friedman_mse', 'mae']), 
        'min_samples_leaf' : hp.uniform('ExtraTreesRegressor_min_samples_leaf', 1, 20, 1),
        'min_samples_split' : hp.quniform('ExtraTreesRegressor_min_samples_split', 2, 20, 1),  
        ...
        'min_weight_fraction_leaf' : hp.choice('ExtraTreesRegressor_min_weight_fraction_leaf', [0.]), 
        'min_impurity_decrease' : hp.choice('ExtraTreesRegressor_min_impurity_decrease', [0.0])
    },
    {
    ...
    },
    {
        ...
        'learning_rate' : hp.loguniform('GradientBoosting_learning_rate', np.log(0.01), np.log(1)), 
        'min_samples_leaf' : scope.int(hp.loguniform('GradientBoosting_min_samples_leaf', \
            np.log(1), np.log(200), 1)), 
        'max_depth' : hp.choice('GradientBoosting_max_depth', [None]),
        'max_leaf_nodes' : scope.int(hp.loguniform('GradientBoosting_max_leaf_nodes', \
            np.log(3), np.log(2047))), 
        'max_bins' : hp.choice('GradientBoosting_max_bins', [255]), 
        'l2_regularization' : hp.loguniform('GradientBoosting_l2_regularization', \
            np.log(1e-10), np.log(1)), 
        'early_stop' : hp.choice('GradientBoosting_early_stop', ['off', 'train', 'valid']), 
        'tol' : hp.choice('GradientBoosting_tol', [1e-7]), 
        'scoring' : hp.choice('GradientBoosting_scoring', ['loss']),
        'n_iter_no_change' : scope.int(hp.quniform('GradientBoosting_n_iter_no_change', \
            1, 20, 1)),
        'validation_fraction' : hp.uniform('GradientBoosting_validation_fraction', 0.01, 0.4)
    },
    {
        'model' : 'KNearestNeighborsRegressor',
        'n_neighbors' : scope.int(hp.loguniform('KNearestNeighborsRegressor_n_neighbors', 1, 100)), 
    ...
    },
    {
        ...
        'loss' : hp.choice('LibLinear_SVR__loss', ['epsilon_insensitive', 'squared_epsilon_insensitive']), 
    ...
    },
    {
        ...
        'hidden_layer_depth' : scope.int(hp.quniform('MLPRegressor_hidden_layer_depth', 1, 3, 1)), 
        'num_nodes_per_layer' : scope.int(hp.loguniform('MLPRegressor_num_nodes_per_layer', \
            np.log(16), np.log(264))), 
        'activation' : hp.choice('MLPRegressor_activation', ['tanh', 'relu']), 
        'alpha' : hp.loguniform('MLPRegressor_alpha', np.log(1e-7), np.log(1e-1)),
        'learning_rate_init' : hp.loguniform('MLPRegressor_learning_rate_init', np.log(1e-4), np.log(0.5)), 
    ...
    {
        'model' : 'RandomForest',
        'criterion' : hp.choice('RandomForest_criterion', ['mse', 'friedman_mse', 'mae']), 
    ...
    },
    {
        ...
        # eta0 only selected for learning_rate in ['constant', 'invscaling']
        # power_t only selected for learning_rate = 'invscaling'
        'loss' : hp.choice('SGD_loss', ['squared_loss', 'huber', 'epsilon_insensitive', \
